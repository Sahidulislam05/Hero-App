    ...
    <div className="container mx-auto">
      <div className="mt-14">
        <div className="card lg:card-side ">
          <figure className=" h-[350px] overflow-hidden rounded-xl">
            <img className="w-[350px] object-cover" src={image} alt="Album" />
          </figure>
          <div className="card-body">
            ...
            <div className="border-b-1 border-gray-300 my-5 "></div>
      ...
      <div className="mb-20 ml-4 md:ml-0 mt-10">
        ...
        <p className="text-[#627382] mt-6 text-left"> {description} </p>
      </div>
